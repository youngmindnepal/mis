...
export const menuConfig = [
  ...
  },
  {
    ...
    permission: { resource: 'employee_attendance', action: 'read' },
  },
  {
    id: 3,
  ...
  },
  {
    ...
    children: [
      {
        id: 41,
        name: 'Preadmission Applications',
        path: '/dashboard/admission/preadmission',
        icon: 'FileText',
    ...
    children: [
      {
        ...
        permission: { resource: 'library', action: 'view' },
      },
      {
        id: 62,
        name: 'E-library',
        path: '/dashboard/library/elibrary',
        icon: 'library',
